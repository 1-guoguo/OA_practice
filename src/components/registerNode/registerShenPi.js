...
class BaseView extends RectNode {
    getLabelShape() {
        ...
        console.log("props", properties.shenpi_name)
        const { shenpi, shenpi_name, shenpi_type } = properties
        ...
        h(
            ...
            [shenpi === null ? shenpi_type : shenpi]
        ),
        // 显示选择审批的名字
        // h(
        //   'text',
        ...
        //       fill: style.stroke
        //   },
        //   [shenpi_name === undefined ? '' : JSON.parse(JSON.stringify(shenpi_name)).length > 1 ? JSON.parse(JSON.stringify(shenpi_name))[0] + '...' : shenpi_name]
        // ),
        h(
            "svg",
            {
